  ...
  <div class='overflow-hidden group rounded-2xl shadow-2xl'>
    ...
    <div class='absolute inset-0 flex items-center justify-center'>
      <img
        ...
        alt='DragonBall Wiki'
        class='w-2/3 h-1/2 sm:h-3/4 lg:h-6/7 object-cover sm:object-fit rounded-2xl shadow-lg transition-transform duration-500 ease-in-out transform group-hover:scale-110'
      />
    </div>
  </div>
</div>
